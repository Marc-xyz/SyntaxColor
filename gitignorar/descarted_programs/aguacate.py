...
'''Comentari:
El arxiu agauate bàsicament servia per extreure el texts dels articles de la Wikipedia, però o feia extraient primer el html i després transformant-lo a text amb el Beautiful soup, massa complicat es va descartar.ar
'''
